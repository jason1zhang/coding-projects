...
public final class StdOut {
    ...
    /**
     * Prints an boolean to this output stream and then terminates the line.
     *
    ...
    /**
     * Prints a short to this output stream and then terminates the line.
     *
     ...
     * string and argument, and then flushes standard output.
     *
    ...
    /**
     * Prints a formatted string to standard output, using the local and
     * specified format string and argument, and then flushes standard output.
     *
